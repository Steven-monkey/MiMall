        ...
        <div class="wrapper">
            <div class="contaniner">
                ...
                <ul class="cart-item-list">
                    <li class="cart-item" v-for="(item, index) in lists " :key="index">
                ...
                <div class="cart-tip fl">
                    <a href="/">继续购物</a>
                    共<span>{{lists.length}}</span>件商品，已选择<span>{{checkedNum}}</span>件
                </div>
                <div class="total fr">
...
export default {
    ...
    methods: {
        ...
        renderData(res){
                ...
                this.checkedNum=this.lists.filter(item=>item.productSelected).length;
        },
        //结算购物车
        order(){
            let isCheck=this.lists.every(item=>!item.productSelected);
            if (isCheck) {
